...
export const parseCliArgs = async (): Promise<any> => {
  return yargs(hideBin(process.argv))
    ...
    .example('$0 --initialUrl https://example.com --depth 2', 'Collect links from example.com up to depth 2')
    .example('$0 --initialUrl https://example.com --filters \'{"domain": "example.com"}\'', 'Only collect links from example.com domain')
